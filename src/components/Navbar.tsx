...
const ThemeToggle = () => {
  ...
  return (
    <button onClick={handleToggle} title={`Switch to ${isDark ? 'light' : 'dark'} mode`}
      style={{
        width: '52px', height: '26px', borderRadius: '13px', border: 'none', cursor: 'pointer',
    ...
    <>
      <header style={{
        ...
        <div style={{
          ...
          padding: '0 20px', height: '58px', gap: '14px',
          maxWidth: '100%',
        }}>
          ...
          <form onSubmit={handleSearch} style={{ flex: 1, display: 'flex', alignItems: 'center', maxWidth: '640px', margin: '0 auto' }}>
            <div style={{
              ...
              borderRadius: '22px 0 0 22px', transition: 'border-color 0.2s, box-shadow 0.2s',
            }}
            ...
            <button type="submit" style={{
              background: '#ff0000',
              border: '1px solid #ff0000', borderRadius: '0 22px 22px 0',
              padding: '9px 18px', cursor: 'pointer', color: 'white',
        ...
        {/* ── BOTTOM NAV BAR: full-width nav links ── */}
        <div style={{
          display: 'flex', alignItems: 'center',
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  color: isActive ? '#ff0000' : 'hsl(var(--foreground))',
                ...
                onMouseEnter={e => {
                  if (!isActive) {
                    ...
                    (e.currentTarget as HTMLElement).style.borderBottomColor = 'rgba(255,0,0,0.3)';
                  }
                }}
                onMouseLeave={e => {
                  if (!isActive) {
      ...
      <div style={{
        ...
        <div style={{ padding: '16px', borderBottom: '1px solid hsl(var(--border))', display: 'flex', alignItems: 'center', gap: '10px', background: isDark ? 'hsl(0 0% 7%)' : 'hsl(var(--secondary))' }}>
          ...
          <button onClick={() => setMobileOpen(false)} style={{ marginLeft: 'auto', ...iconBtn }}>
            <X size={18} />
          </button>
        </div>
