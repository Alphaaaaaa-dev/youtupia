...
const DEFAULT_CREATORS: Creator[] = [
  ...
  { id: 'creator2', name: 'Techno Gamerz', handle: 'technogamerz', bio: 'Gaming king of India. Every piece in this collection is designed for the grind. Rep the culture.', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=200&h=200&fit=crop&crop=face', banner: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&h=400&fit=crop', subscribers: '36M', productIds: ['p2', 'p6'], dropCountdownEnd: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString() },
];
const DEFAULT_DROPS: Drop[] = [
  { id: 'drop001', name: 'Drop 001 — The OG', description: 'Where it all started. Timeless pieces for the community that built us.', dropNumber: 1, theme: 'Streetwear Classics', banner: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=1200&h=400&fit=crop', productIds: ['p1', 'p3', 'p5'], limited: false },
  { id: 'drop002', name: 'Drop 002 — Street', description: 'Bold. Unapologetic. Built for the culture. Limited run, never restocking.', dropNumber: 2, theme: 'Urban Streetwear', banner: 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=1200&h=400&fit=crop', endsAt: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(), productIds: ['p2', 'p4', 'p6'], limited: true },
];
const DEFAULT_SERIES: Series[] = [
  { id: 'classic', name: 'Classic Drop', description: 'The OG collection. Timeless pieces that started it all.', logo: 'https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=80&h=80&fit=crop', banner: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=1200&h=400&fit=crop', color: '#3b82f6' },
  { id: 'streetwear', name: 'Street Series', description: 'Bold, unapologetic streetwear for the culture.', logo: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=80&h=80&fit=crop', banner: 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=1200&h=400&fit=crop', color: '#f97316' },
];
const DEFAULT_PRODUCTS: Product[] = [
  { id: 'p1', name: 'OG Logo Tee', series: 'Classic Drop', seriesId: 'classic', creatorId: 'creator1', dropId: 'drop001', price: 799, originalPrice: 999, description: 'The original Youtupia logo tee. 100% cotton, heavyweight 240gsm. Drop-shoulder fit.', images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&h=700&fit=crop', 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=600&h=700&fit=crop'], variants: [{ size: 'S', stock: 10 }, { size: 'M', stock: 15 }, { size: 'L', stock: 8 }, { size: 'XL', stock: 5 }, { size: 'XXL', stock: 3 }], tags: ['tshirt', 'logo', 'bestseller'], featured: true, createdAt: '2026-01-01', viewerCount: 14, reviews: [{ id: 'r1', userName: 'Rahul K.', rating: 5, comment: 'Absolute fire quality! The cotton is so thick and the fit is perfect.', createdAt: '2026-02-15', verified: true }, { id: 'r2', userName: 'Priya M.', rating: 4, comment: 'Great tee, runs slightly large. Order one size down.', createdAt: '2026-03-01', verified: true }] },
  { id: 'p2', name: 'Street Hoodie Black', series: 'Street Series', seriesId: 'streetwear', creatorId: 'creator2', dropId: 'drop002', price: 1799, originalPrice: 2199, description: 'Heavyweight 380gsm fleece hoodie. Oversized fit. Kangaroo pocket. Ribbed cuffs.', images: ['https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=600&h=700&fit=crop', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&h=700&fit=crop'], variants: [{ size: 'S', stock: 5 }, { size: 'M', stock: 12 }, { size: 'L', stock: 10 }, { size: 'XL', stock: 7 }, { size: 'XXL', stock: 2 }], tags: ['hoodie', 'street', 'bestseller'], featured: true, createdAt: '2026-01-15', viewerCount: 27, limitedEdition: true, dropEndsAt: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(), reviews: [{ id: 'r3', userName: 'Arjun S.', rating: 5, comment: "Best hoodie I've ever owned. The 380gsm is insane quality.", createdAt: '2026-02-20', verified: true }] },
  { id: 'p3', name: 'Classic Cap', series: 'Classic Drop', seriesId: 'classic', creatorId: 'creator1', dropId: 'drop001', price: 499, description: '6-panel structured cap. Embroidered logo. One size fits all.', images: ['https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=600&h=700&fit=crop'], variants: [{ size: 'One Size', stock: 20 }], tags: ['cap', 'accessory'], featured: false, createdAt: '2026-02-01', viewerCount: 6 },
  { id: 'p4', name: 'Street Cargo Tee', series: 'Street Series', seriesId: 'streetwear', dropId: 'drop002', price: 999, description: 'Washed cotton tee with cargo pocket detail. Relaxed fit. Vintage feel.', images: ['https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=600&h=700&fit=crop', 'https://images.unsplash.com/photo-1562157873-818bc0726f68?w=600&h=700&fit=crop'], variants: [{ size: 'S', stock: 8 }, { size: 'M', stock: 14 }, { size: 'L', stock: 11 }, { size: 'XL', stock: 6 }], tags: ['tshirt', 'street'], featured: true, createdAt: '2026-02-10', viewerCount: 9 },
  { id: 'p5', name: 'OG Sticker Pack', series: 'Classic Drop', seriesId: 'classic', dropId: 'drop001', price: 199, description: 'Pack of 6 vinyl stickers. Waterproof. Perfect for laptops, bottles, skateboards.', images: ['https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&h=700&fit=crop'], variants: [{ size: 'Pack of 6', stock: 50 }], tags: ['sticker', 'accessory'], featured: false, createdAt: '2026-02-20', viewerCount: 3 },
  { id: 'p6', name: 'Street Bomber Jacket', series: 'Street Series', seriesId: 'streetwear', creatorId: 'creator2', dropId: 'drop002', price: 2999, originalPrice: 3499, description: 'Premium bomber jacket. Satin shell. Embroidered patches. Limited run.', images: ['https://images.unsplash.com/photo-1551028719-00167b16eac5?w=600&h=700&fit=crop'], variants: [{ size: 'S', stock: 3 }, { size: 'M', stock: 5 }, { size: 'L', stock: 4 }, { size: 'XL', stock: 2 }], tags: ['jacket', 'street', 'limited'], featured: true, createdAt: '2026-03-01', viewerCount: 31, limitedEdition: true, dropEndsAt: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString() },
];
